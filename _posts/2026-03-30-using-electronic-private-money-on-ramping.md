...
> Editor's note: This post is the first in a four-part series about making privacy-preserving cryptocurrency accessible and useful for underserved populations. Its original author, [Violet Rollergirl](https://VioletRollergirl.com/){:target="_blank"}, is a transgender sex worker who has modified the post from [its original](https://VioletRollergirl.com/resources/for-providers/using-cryptocurrency/on-ramping/){:target="_blank"} in order to speak to a broader audience. We are republishing her work here with her express permission.
